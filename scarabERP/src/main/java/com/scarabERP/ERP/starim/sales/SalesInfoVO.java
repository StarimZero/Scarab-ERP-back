...
public class SalesInfoVO {
	...
	public String toString() {
		return "SalesInfoVO [sales_info_id=" + sales_info_id + ", sales_id=" + sales_id + ", sales_items_id="
				+ sales_items_id + ", sales_qnt=" + sales_qnt + ", sales_warehouse=" + sales_warehouse
				+ ", sales_price=" + sales_price + ", sales_employee=" + sales_employee + ", sales_location="
